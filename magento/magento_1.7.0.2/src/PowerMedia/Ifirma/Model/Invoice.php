 ...
 * @author platowski
 */
class PowerMedia_Ifirma_Model_Invoice {
	...
	public function getSpozobZaplaty() {
		return $this->SposobZaplaty;
	}

	public function setSpozobZaplaty($sposob_zaplaty) {
		return $this->SposobZaplaty = $sposob_zaplaty;
	}
