...
class PowerMedia_Ifirma_Model_Builder_StrategyProforma extends PowerMedia_Ifirma_Model_Builder_StrategyAbstract{
	...
	public function makeInvoice() {
		...
		$invoiceProforma->{ifirma\Invoice::KEY_MIEJSCE_WYSTAWIENIA} = $this->_getConfig()->{ifirma\Config::API_MIEJSCE_WYSTAWIENIA};
		$invoiceProforma->{ifirma\Invoice::KEY_NAZWA_SERII_NUMERACJI} = $this->_getConfig()->{ifirma\Config::API_NAZWA_SERII_NUMERACJI};
