...
class PowerMedia_Ifirma_Model_Builder_StrategyInvoice extends PowerMedia_Ifirma_Model_Builder_StrategyAbstract{
	...
	public function makeInvoice() {
		...
		$invoice->{ifirma\Invoice::KEY_MIEJSCE_WYSTAWIENIA} = $this->_getConfig()->{ifirma\Config::API_MIEJSCE_WYSTAWIENIA};
		$invoice->{ifirma\Invoice::KEY_NAZWA_SERII_NUMERACJI} = $this->_getConfig()->{ifirma\Config::API_NAZWA_SERII_NUMERACJI};
