...
class PowerMedia_Ifirma_Model_Builder_StrategyInvoiceSend extends PowerMedia_Ifirma_Model_Builder_StrategyAbstract{
	...
	public function makeInvoice() {
		...
		$invoiceSend->{ifirma\InvoiceSend::KEY_MIEJSCE_WYSTAWIENIA} = $this->_getConfig()->{ifirma\Config::API_MIEJSCE_WYSTAWIENIA};
		$invoiceSend->{ifirma\InvoiceSend::KEY_NAZWA_SERII_NUMERACJI} = $this->_getConfig()->{ifirma\Config::API_NAZWA_SERII_NUMERACJI};
