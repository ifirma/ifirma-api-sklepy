...
$this->language->load('module/ifi_invoice');
                                $data['tab_ifirma'] = $this->language->get('tab_ifirma');
                                $data['configuration_not_set_msg'] = $this->language->get('configuration_not_set');
                                $this->language->load('sale/order');
$this->language->load('module/ifi_invoice');$data['tab_ifirma'] = $this->language->get('tab_ifirma');$this->language->load('sale/order');
...
$this->load->model('module/invoice_map');
			...
			$data['isIfiModuleInstalled'] = $isIfiModuleInstalled;
			    ...
			    $array = array('hash' => $ifi_invoice[ModelModuleInvoiceMap::API_HASH],
                            ...
                            $data['get_proforma'] = $this->url->link('module/ifi_invoice/getInvoice', 'token=' . $this->session->data['token'], 'SSL');}
