    ...
    <div class="content">
      <form action="" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          <thead>
            <tr>
			  ...
			  <!-- IFIRMA - start -->
            <td class="right">Księgowość internetowa - IFirma.pl</td>
            <!-- IFIRMA - koniec -->
            </tr>
          </thead>
          <tbody>
		...
		if (isset($order)) {
		   ...
		   <!--IFIRMA start-->
      Księgowość internetowa IFirma.pl - <a href="view/template/sale/api_configuration.php?token=<?php echo $this->session->data['token'];?>">Konfiguracja</a>
