      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-store">
          <table class="form">
			...
			<tr>
				<td><?php echo 'Księgowość internetowa IFirma.pl';?></td>
				<td><a href="view/template/sale/api_configuration.php?token=<?php echo $this->session->data['token'];?>">Konfiguracja</a></td>
			</tr>
          </table>
        </div>
        <div id="tab-local">
