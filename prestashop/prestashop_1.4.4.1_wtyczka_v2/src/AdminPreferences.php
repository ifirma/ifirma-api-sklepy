...
class AdminPreferences extends AdminTab
{
	...
	protected function _displayForm($name, $fields, $tabname, $size, $icon)
	{
		...
		if (!is_writable(PS_ADMIN_DIR.'/../config/settings.inc.php') AND $name == 'themes')
			...
			echo '<div style="clear:both; padding-top:15px;"><label>Księgowość internetowa IFirma.pl</label><div class="margin-form" style="padding-top:5px">W celu korzystania z serwisu IFirma.pl należy uzupełnić konfigurację znajdującą się pod następującym linkiem - <a href="api_configuration.php">Konfiguracja API</a></div></div>';
