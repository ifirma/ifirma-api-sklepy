...
require_once dirname(__FILE__) . '/InvoiceBill.php';
require_once dirname(__FILE__) . '/../GetPdfInterface.php';

/**
 * Description of InvoiceBillResponse
 *
 * @author bbojanowicz
 */
class InvoiceBillResponse extends InvoiceBill implements GetPdfInterface{
	...
	public function getPdf($id){
		return ConnectorAbstract::factory($this)->receivePdf($id);
	}
}
