...
require_once dirname(__FILE__) . '/InvoiceSend.php';
require_once dirname(__FILE__) . '/../GetPdfInterface.php';

/**
 * Description of InvoiceSendResponse
 *
 * @author bbojanowicz
 */
class InvoiceSendResponse extends InvoiceSend implements GetPdfInterface{
